...
public:
   ...
   * Properties: NOT thread-safe.
   */
  threadpool11_EXPORT size_t get_worker_count() const;
   ...
   * Properties: thread-safe.
   */
  threadpool11_EXPORT size_t get_work_queue_size() const;
   ...
   * Properties: NOT thread-safe.
   */
  threadpool11_EXPORT void decrease_worker_count(size_type n = std::numeric_limits<size_t>::max(),
