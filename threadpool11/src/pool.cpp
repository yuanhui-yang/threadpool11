...
size_t pool::get_worker_count() const { return worker_count_; }
...
pool::size_type pool::get_work_queue_size() const { return work_queue_size_.load(std::memory_order_relaxed); }
